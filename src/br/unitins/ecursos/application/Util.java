...
public class Util {
	...
	public static void mensagemError(String msg) {
		mandarMensagem(null, FacesMessage.SEVERITY_ERROR, msg);
	}

	public static void mensagemError(String clientId, String msg) {
		mandarMensagem(clientId, FacesMessage.SEVERITY_ERROR, msg);
	}

	public static void mensagemInfo(String msg) {
		mandarMensagem(null, FacesMessage.SEVERITY_INFO, msg);
	}

	private static void mandarMensagem(String clientId, Severity severity, String msg) {
	...
	public static void redirecionar(String page) {
		try {
			...
			e.printStackTrace();
			mensagemError("Problemas ao redirecionar a página.");
		}
	}
